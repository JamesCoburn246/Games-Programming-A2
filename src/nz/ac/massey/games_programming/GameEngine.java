...
public abstract class GameEngine implements KeyListener, MouseListener, MouseMotionListener {
    ...
    public void drawSolidPolygon(GeneralPath polygon) {
        // Fill a Polygon
    ...
    public void drawText(double x, double y, String s, int size) {
        ...
        int lineHeight = mGraphics.getFontMetrics().getHeight();
        // NOTE: I MADE THIS ADJUSTMENT:
        for (String line : s.split("\n"))
            mGraphics.drawString(line, (int) x, (int) (y += lineHeight));
    }
    ...
    // Stack of transforms
    final Stack<AffineTransform> mTransforms;
